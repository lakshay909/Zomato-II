...
![Application Dashboard](./screenshot/Screenshot%202026-03-21%20at%201.16.02%20PM.png)
*Discover a curated feed of dishes submitted by partners.*

### 2. Login / Authentication Gateway
![Login Page](./screenshot/Screenshot%202026-03-21%20at%201.13.45%20PM.png)
*Secure role-based entry point for standard users and verified partners.*

### 3. Food Partner Profile View
![Partner Profile](./screenshot/Screenshot%202026-03-21%20at%201.16.51%20PM.png)
*Detailed catalog showcasing partner offerings and likes.*

*(Note: Adjust the captions above as necessary to perfectly match the visible screens)*
